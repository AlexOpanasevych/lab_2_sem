...
int coord::operator +(const coord &obj){         //cannot convert 'coord' to 'int' in return return temp;
	coord temp;                                  //Не існує конвертора з класового типу даних в тип даних int
	temp.x = x + obj.x;
	temp.y = y + obj.y;
	return temp;
}
